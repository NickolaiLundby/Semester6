...
public class DetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnOkay = (Button)rootView.findViewById(R.id.details_btnOkay);
        title = (TextView)rootView.findViewById(R.id.details_title);
        imdbRating = (TextView)rootView.findViewById(R.id.details_imdbRating);
        yourRating = (TextView)rootView.findViewById(R.id.details_yourRating);
        plot = (TextView)rootView.findViewById(R.id.details_plot);
        comment = (TextView)rootView.findViewById(R.id.details_comment);
        watched = (CheckBox)rootView.findViewById(R.id.details_watched);
        picture = (ImageView)rootView.findViewById(R.id.details_picture);
        genre = (TextView)rootView.findViewById(R.id.details_genres);
    ...
    private void ButtonOkayClicked()
    {
